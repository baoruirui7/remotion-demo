...
export const Scene4Mission: React.FC = () => {
  ...
  // Main text letter-by-letter reveal
  const mainText = "让信息找到人";
  const subText = "用技术改变世界";

  const mainOpacity = interpolate(frame, [15, 45], [0, 1], {
  ...
  const ringOpacity = interpolate(frame, [0, 30, 90, 120], [0, 0.15, 0.1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  // Character stagger for main text
  ...
  return (
    <AbsoluteFill
      style={{
        background: "linear-gradient(135deg, #B23000 0%, #FF4500 40%, #FF6A00 100%)",
        display: "flex",
